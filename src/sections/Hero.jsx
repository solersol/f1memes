const Hero = () => {
  return (
    <section id="home" className="w-full flex flex-col justify-center items-center min-h-screen  pt-56 bg-cover bg-center">
      ...
      <a href="https://pump.fun/EY1sdTG1X9fUX7sjJ6CRKtijA8gmJBCCsmcpbaQqZdYr"><button className="mt-6 bg-[#0a2d6b] text-[#fff] rounded-full px-10 py-4 hover:bg-[#ff0000] font-anton text-[24px]">
        BUY $F1MEMES
      </button></a>
    </section>
  );
